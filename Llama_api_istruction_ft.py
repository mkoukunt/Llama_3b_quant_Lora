...
Think to identify the api method among GET,POST, PUT nd DELETE . If it is a POST method , then provide the post body also.
"""
...
file_path = "./data/api-instruction-data.json"
url = (
...
model.save_pretrained("./Laala-3.2-3B-inst-api")
tokenizer.save_pretrained("./Laala-3.2-3B-inst-api")